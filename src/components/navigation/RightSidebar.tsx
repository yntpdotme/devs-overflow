...
const RightSidebar = () => {
  return (
    <section className="custom-scrollbar custom-scrollbar-left background-light900_dark200 light-border sticky left-0 top-0 flex h-full w-[300px] flex-col gap-6 overflow-y-auto border-r p-8 pb-6 pt-10 shadow-light-300 dark:shadow-none max-xl:hidden">
      <div>
