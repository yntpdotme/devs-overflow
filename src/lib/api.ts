...
export const api = {
  ...
  users: {
    ...
    create: (userData: Partial<UserType>) =>
      fetchHandler(`${API_BASE_URL}/users`, {
        method: "POST",
        body: JSON.stringify(userData),
      }),
    update: (id: string, userData: Partial<UserType>) =>
  ...
  accounts: {
    ...
    create: (accountData: Partial<AccountType>) =>
      fetchHandler(`${API_BASE_URL}/accounts`, {
        method: "POST",
        body: JSON.stringify(accountData),
      }),
    update: (id: string, accountData: Partial<AccountType>) =>
